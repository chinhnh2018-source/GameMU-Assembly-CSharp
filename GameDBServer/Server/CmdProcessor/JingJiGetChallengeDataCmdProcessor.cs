...
namespace GameDBServer.Server.CmdProcessor
{
	public class JingJiGetChallengeDataCmdProcessor : ICmdProcessor
	{
		...
		public void processCmd(GameServerClient client, int nID, byte[] cmdParams, int count)
		{
			...
			List<PlayerJingJiMiniData> challengeData = JingJiChangManager.getInstance().getChallengeData(challengeRankings);
			client.sendCmd<List<PlayerJingJiMiniData>>(10141, challengeData);
		}
