...
namespace Server.Data
{
	...
	public class RingRankingInfo
	{
		...
		[DBMapping(ColumnName = "goodwilllevel"), ProtoMember(3)]
		public int byGoodwilllevel = 0;

		[ProtoMember(4), DBMapping(ColumnName = "goodwillstar")]
		public int byGoodwillstar = 0;

		[DBMapping(ColumnName = "ringid"), ProtoMember(5)]
		public int nRingID;

		[ProtoMember(6), DBMapping(ColumnName = "changtime")]
