...
namespace Server.Data
{
	...
	public class UpdateGoodsArgs
	{
		public void CopyPropsTo(GoodsData gd)
		{
			...
			{
				foreach (UpdatePropIndexes updatePropIndexes in this.ChangedIndexes)
				{
					UpdatePropIndexes updatePropIndexes2 = updatePropIndexes;
					if (updatePropIndexes2 != UpdatePropIndexes.binding)
					{
						switch (updatePropIndexes2)
						{
