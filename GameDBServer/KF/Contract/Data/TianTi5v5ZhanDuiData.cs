...
namespace KF.Contract.Data
{
	...
	public class TianTi5v5ZhanDuiData
	{
		...
		{
			TianTi5v5ZhanDuiData tianTi5v5ZhanDuiData = base.MemberwiseClone() as TianTi5v5ZhanDuiData;
			if (null != this.teamerList)
			{
				tianTi5v5ZhanDuiData.teamerList = new List<TianTi5v5ZhanDuiRoleData>();
				foreach (TianTi5v5ZhanDuiRoleData tianTi5v5ZhanDuiRoleData in this.teamerList)
				{
					tianTi5v5ZhanDuiData.teamerList.Add(tianTi5v5ZhanDuiRoleData.Clone());
				}
			}
