...
namespace GameServer.Logic.JingJiChang
{
	public class JingJiChangConstants
	{
		...
		public static int[] GetJingJiChangeSkillList(GameClient client, int eOccupation, EMagicSwordTowardType eMagicSwordType)
		{
			...
			{
			case 0:
				list.AddRange(JingJiChangConstants.ZhanShiSkillList);
				break;
			case 1:
				list.AddRange(JingJiChangConstants.FaShiSkillList);
				break;
			case 2:
				list.AddRange(JingJiChangConstants.GongJianShouSkillList);
				break;
			case 3:
				switch (eMagicSwordType)
				{
				case EMagicSwordTowardType.EMST_Strength:
					list.AddRange(JingJiChangConstants.StrMagicSwordSkillList);
					break;
				case EMagicSwordTowardType.EMST_Intelligence:
					list.AddRange(JingJiChangConstants.IntMagicSwordSkillList);
					break;
				}
				break;
			case 5:
				list.AddRange(JingJiChangConstants.SummonerSkillList);
				break;
			}
			list.AddRange(ZuoQiManager.getInstance().GetZuoQiSkillList(client));
			return list.ToArray();
		}
