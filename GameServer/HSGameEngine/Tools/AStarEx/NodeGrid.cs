...
namespace HSGameEngine.Tools.AStarEx
{
	public class NodeGrid : ICloneable
	{
		...
		public bool isDiagonalWalkable(long node1, long node2)
		{
			...
			return 1 == this._fixedObstruction[guid_X, guid_Y2] && 1 == this._fixedObstruction[guid_X2, guid_Y];
		}
		...
		public object Clone()
		{
			NodeGrid nodeGrid = base.MemberwiseClone() as NodeGrid;
			nodeGrid._fixedObstruction = (this._fixedObstruction.Clone() as byte[,]);
			return nodeGrid;
		}
