...
namespace KF.Remoting.HuanYingSiYuan.TcpStaticClient
{
	public class KfCall
	{
		public static Client NewTcpClient(ServerAttribute attribute, Action<SubArray<byte>> onCustomData, ILog log, Func<ClientSocketSender, bool> verifyMethod)
		{
			KfCall.TcpClient = new Client(attribute, onCustomData, log, verifyMethod);
			...
			Type[] array6 = array;
			array = new Type[1];
			tcpClient.ClientCompileSerialize(array2, array3, array4, array5, array6, array);
		...
		public sealed class ClientConfig
		{
			...
			public Func<ClientSocketSender, bool> VerifyMethod;
		}
	}
}
