...
namespace KF.Remoting
{
	internal class CoupleArenaJoinMatcher
	{
		...
		{
			List<CoupleArenaJoinData> list;
			if (!this.JoinDatasDict.TryGetValue(unionDuanwei, out list))
			{
				list = new List<CoupleArenaJoinData>();
				this.JoinDatasDict.Add(unionDuanwei, list);
			}
			return list;
		}
