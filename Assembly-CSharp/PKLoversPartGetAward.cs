...
public class PKLoversPartGetAward : UserControl
{
	...
	public void InitListItem(int paiming, int awardID)
	{
		this.loadGoodsList(PKLoversPart.GetCoupleWarAwardDic()[awardID].Award);
		this.GetMiaoShu(paiming);
	}

	private void GetMiaoShu(int paiming)
	{
