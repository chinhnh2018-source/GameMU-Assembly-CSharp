...
public class ConfigZhanMengLianSaiLeagueNewAward
{
	public ConfigZhanMengLianSaiLeagueNewAward()
	{
		XElement gameResXml = Global.GetGameResXml("Config/LeagueNewAward.xml");
		if (gameResXml != null)
		{
			List<XElement> xelementList = Global.GetXElementList(gameResXml, "LeagueNewAward");
	...
	public LianSaiLeagueSuperAwardVO GetLianSaiAwardVOByID(int ID)
	{
	...
	private const string path = "Config/LeagueNewAward.xml";
