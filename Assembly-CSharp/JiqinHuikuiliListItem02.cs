...
public class JiqinHuikuiliListItem02 : UserControl
{
	public JiqinHuikuiliListItem02()
	{
		this.Container.Children.Add(this.txtItem);
		this.txtItem.BodyWidth = 86.0;
		Canvas.SetLeft(this.txtItem, 5);
		Canvas.SetTop(this.txtItem, 15);
		this.txtItem.TextColor = new SolidColorBrush(16777080U);
		this.txtItem.fontBold = true;
		this.Container.Children.Add(this.txtItem2);
		this.txtItem2.BodyWidth = 120.0;
		Canvas.SetLeft(this.txtItem2, 200);
		Canvas.SetTop(this.txtItem2, 15);
		this.txtItem2.TextColor = new SolidColorBrush(16777080U);
		this.Container.Children.Add(this.listBox);
		this.listBox.Background = new SolidColorBrush(16777215U);
		this.listBox.Width = 90.0;
		this.listBox.Height = 32.0;
		Canvas.SetLeft(this.listBox, 110);
		Canvas.SetTop(this.listBox, 5);
		this.ItemCollection = this.listBox.ItemsSource;
		this.Container.Children.Add(this.btnCanvas);
		this.btnCanvas.Width = 50.0;
		this.btnCanvas.Height = 29.0;
		Canvas.SetLeft(this.btnCanvas, 350);
		Canvas.SetTop(this.btnCanvas, 10);
	}
	...
	public uint TextColor
	{
		set
		{
			this.txtItem.TextColor = new SolidColorBrush(value);
		}
	}
	...
	private void AddGoodsIcon(int goodsID, int gcount, int quality, int forgeLevel, int binding, int born, int Id = -1)
	{
		...
		if (goodsXmlNodeByID != null)
		{
			...
			goodsPackItem.GoodsImgBacks = Global.GetGameResImage("Images/Plate/rm_listItem3.png");
	...
	private GTextBlockOutLine txtItem2 = new GTextBlockOutLine(string.Empty, -1, -1, -1, -1, -1);
