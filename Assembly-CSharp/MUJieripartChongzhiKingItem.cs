...
public class MUJieripartChongzhiKingItem : UserControl
{
	protected override void InitializeComponent()
	{
		...
		this.btnLingqu.MouseLeftButtonUp = delegate(object s, MouseEvent e)
		{
			...
			{
				GameInstance.Game.SpriteFetchActivityAward(16, this.Id);
			}
		};
	}
	...
	public int Need
	{
		...
		set
		{
			...
			{
				"f2e1bd",
				string.Format(Global.GetLang("最低充值{0}钻石"), this.Need)
			});
		}
	}
	...
	public static bool IsTongGuo(string goodStr, int roleOcc)
	{
		...
		if (roleOcc == 5 && ConfigSystemParam.GetSystemParamByName("ZHSDaTianShi", true).Contains(goodStr))
		{
			return false;
		}
