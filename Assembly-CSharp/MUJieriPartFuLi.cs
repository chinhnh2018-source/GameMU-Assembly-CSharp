...
public class MUJieriPartFuLi : UserControl
{
	...
	private void InitData(string strXML)
	{
		...
		for (int i = 0; i < xelementList3.Count; i++)
		{
			...
			int xelementAttributeInt2 = Global.GetXElementAttributeInt(xelement4, "Button");
			if (xelementAttributeInt2 != 0)
			{
				...
				int xelementAttributeInt4 = Global.GetXElementAttributeInt(xelement4, "TypeID");
				...
				MUJieriPartFuLiItem mujieriPartFuLiItem = U3DUtils.NEW<MUJieriPartFuLiItem>();
				this.ItemCollection.Add(mujieriPartFuLiItem);
				mujieriPartFuLiItem.LabName = xelementAttributeStr6;
				mujieriPartFuLiItem.LabTime = string.Format(Global.GetLang("{0}至{1}"), xelementAttributeStr7, xelementAttributeStr8);
				mujieriPartFuLiItem.Link = xelementAttributeInt5;
				mujieriPartFuLiItem.Effective = xelementAttributeInt2;
				mujieriPartFuLiItem.TypeID = xelementAttributeInt4;
			}
		}
	}
