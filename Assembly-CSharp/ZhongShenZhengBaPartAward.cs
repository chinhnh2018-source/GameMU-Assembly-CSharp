...
public class ZhongShenZhengBaPartAward : UserControl
{
	...
	public void InitListItem(int day)
	{
		this.loadGoodsList(ZhongShenZhengBaPart.GetDicMatchAward()[day].Award);
		this.GetMiaoShu(day);
	}

	private void GetMiaoShu(int day)
	{
		this.Miaoshu.text = Global.GetColorStringForNGUIText(new object[]
		{
			"fac60d",
			string.Format(Global.GetLang("恭喜您，在本次众神争霸活动中获得{0}，奖励如下"), ZhongShenZhengBaPart.GetDicMatchAward()[day].Name)
		});
	}
