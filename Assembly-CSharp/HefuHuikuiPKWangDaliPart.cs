...
public class HefuHuikuiPKWangDaliPart : UserControl
{
	...
	public void InitPartSize(int width, int height)
	{
		...
		gicon.MouseLeftButtonUp = delegate(object s, MouseEvent e)
		{
			...
			GameInstance.Game.SpriteFetchActivityAward(24, 0);
		};
		this.BtnArr[0] = gicon;
	...
	public void GetData(bool isInLingquTime)
	{
		this.LoadingWin = U3DUtils.NEW<LoadingWindow>();
		this.Container.Children.Add(this.LoadingWin);
		GameInstance.Game.SpriteQueryHeFuPKKing();
	}
	...
	private bool IsMeByPaiHang()
	{
		...
		if (Global.Data.roleData.RoleID == this.state.RoleID)
		{
			result = true;
		}
		return result;
	...
	public void OnLingquCompleted(int result)
	{
		...
		if (result >= 0)
		{
			GGameInfocs.AddGameInfoMessage(GameInfoTypeIndexes.Hot, ShowGameInfoTypes.ErrAndBox, Global.GetLang("恭喜你，成功领取了PK王大礼包"), 0, -1, -1, 0);
