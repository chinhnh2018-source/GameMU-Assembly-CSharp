...
public class MUJieriPartLeijiXiaofeiItem : UserControl
{
	...
	protected override void InitializeComponent()
	{
		...
		{
			if (!this.lingquBtn.enabled)
			{
				return;
			}
			GameInstance.Game.SpriteFetchActivityAward(40, this.Id);
		};
	...
	public int Need
	{
		...
		set
		{
			...
			{
				"dac7ae",
				string.Format(Global.GetLang("活动累计消费{0}钻石"), this.Need)
			});
		}
	}
