...
public class SharePartZhaoHui : UserControl
{
	private void InitTextInPrefabs()
	{
		this.TextHint.Text = Global.GetLang(string.Empty);
	}
	...
	protected override void InitializeComponent()
	{
		...
		{
			string text = ConfigSystemParam.GetSystemParamByName("OldHttp", true);
			if (text == null || text == string.Empty)
			{
				text = "http://www.tmsk.cn/zhaohui/";
			}
			PlatSDKMgr.WXShareUrl(text, string.Concat(new object[]
			{
				Global.GetLang("好久不见了，现在回归即可领取丰,厚好礼，我在"),
