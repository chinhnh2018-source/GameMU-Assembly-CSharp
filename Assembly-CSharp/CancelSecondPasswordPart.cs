...
public class CancelSecondPasswordPart : UserControl
{
	private void InitTextInPrefabs()
	{
		this.Title.text = Global.GetLang("取消密码");
	...
	protected override void InitializeComponent()
	{
		...
		this.ConfirmIcon.MouseLeftButtonUp = new MouseLeftButtonUpEventHandler(this.SubmitCancelSecondPassword);
	...
	private void SubmitCancelSecondPassword(object sender, MouseEvent e)
	{
		...
		GameInstance.Game.CancelSecondPassword(data);
	}
