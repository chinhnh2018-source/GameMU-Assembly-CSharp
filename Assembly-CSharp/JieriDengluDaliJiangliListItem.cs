...
public class JieriDengluDaliJiangliListItem : UserControl
{
	public JieriDengluDaliJiangliListItem()
	{
		this.Container.Children.Add(this.txtDayNum);
		this.txtDayNum.BodyWidth = 86.0;
		Canvas.SetLeft(this.txtDayNum, 5);
		...
		this.listBox.Width = 205.0;
		this.listBox.Height = 32.0;
		Canvas.SetLeft(this.listBox, 85);
		...
		Canvas.SetLeft(this.btnCanvas, 300);
		Canvas.SetTop(this.btnCanvas, 10);
	}

	public int TxtDayNumWidth
	{
		set
		{
			Canvas.SetLeft(this.listBox, value + 5);
			Canvas.SetLeft(this.btnCanvas, (double)(value + 5) + this.listBox.Width);
		}
	}
