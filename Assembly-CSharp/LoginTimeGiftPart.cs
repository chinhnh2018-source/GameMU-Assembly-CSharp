...
public class LoginTimeGiftPart : UserControl
{
	public LoginTimeGiftPart()
	{
	...
	protected override void InitializeComponent()
	{
		...
		Canvas.SetLeft(this.listBox2, 154);
		Canvas.SetTop(this.listBox2, 240);
		...
		Canvas.SetLeft(this.listBox3, 154);
		Canvas.SetTop(this.listBox3, 292);
	...
	private void CreateBackground(int iday, int BackgroundCont)
	{
		for (int i = 0; i < BackgroundCont; i++)
		{
			...
			gicon.Width = 40.0;
			gicon.Height = 40.0;
			gicon.BodySource = new ImageBrush(Global.GetGameResImage("Images/Plate/xtsl_rec1.png"));
			Canvas.SetLeft(gicon, 169 + i * 40 + i * 10);
			Canvas.SetTop(gicon, 189 + iday * 52);
			this.Container.Children.Add(gicon);
		}
	}
