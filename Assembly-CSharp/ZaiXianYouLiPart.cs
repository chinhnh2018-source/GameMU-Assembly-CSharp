...
public class ZaiXianYouLiPart : UserControl
{
	protected override void InitializeComponent()
	{
		this.Container.Children.Add(this.YinLiangText);
		Canvas.SetLeft(this.YinLiangText, 363);
		Canvas.SetTop(this.YinLiangText, 56);
		this.YinLiangText.TextColor = new SolidColorBrush(3669815U);
		...
		Canvas.SetTop(this.ultimoText, 163);
		this.ultimoText.TextColor = new SolidColorBrush(3669815U);
		...
		Canvas.SetTop(this.thisTimeText, 186);
		this.thisTimeText.TextColor = new SolidColorBrush(3669815U);
		...
		Canvas.SetLeft(this.Time1Text, 45);
		Canvas.SetTop(this.Time1Text, 292);
		...
		Canvas.SetLeft(this.Time2Text, 45);
		Canvas.SetTop(this.Time2Text, 332);
		...
		Canvas.SetLeft(this.Time3Text, 45);
		Canvas.SetTop(this.Time3Text, 372);
		...
		Canvas.SetLeft(this.Award1Text, 162);
		Canvas.SetTop(this.Award1Text, 292);
		this.Award1Text.TextColor = new SolidColorBrush(3669815U);
		...
		Canvas.SetLeft(this.Award2Text, 162);
		Canvas.SetTop(this.Award2Text, 332);
		this.Award2Text.TextColor = new SolidColorBrush(3669815U);
		...
		Canvas.SetLeft(this.Award3Text, 162);
		Canvas.SetTop(this.Award3Text, 372);
		this.Award3Text.TextColor = new SolidColorBrush(3669815U);
	...
	public void InitPartData()
	{
		...
		for (int i = 0; i < xelementList.Count; i++)
		{
			...
			if (i == 0)
			{
				...
				this.Award1Text.Text = StringUtil.substitute(Global.GetLang("免费领取 {0} 绑定钻石"), new object[]
				{
					Global.GetXElementAttributeStr(xelement, "BindYuanBao")
				});
				num += Global.GMax(Global.GetXElementAttributeInt(xelement, "BindYuanBao"), 0);
			}
			else if (i == 1)
			{
				this.TimeOl2 = Global.GetXElementAttributeInt(xelement, "TimeOl");
				this.Time2Text.Text = this.TimeOl2 + Global.GetLang(" 小时");
				this.Award2Text.Text = StringUtil.substitute(Global.GetLang("免费领取 {0} 绑定钻石"), new object[]
				{
					Global.GetXElementAttributeStr(xelement, "BindYuanBao")
				});
				num += Global.GMax(Global.GetXElementAttributeInt(xelement, "BindYuanBao"), 0);
			...
			else if (i == 2)
			{
				...
				this.Award3Text.Text = StringUtil.substitute(Global.GetLang("免费领取 {0} 绑定钻石"), new object[]
				{
					Global.GetXElementAttributeStr(xelement, "BindYuanBao")
				});
				num += Global.GMax(Global.GetXElementAttributeInt(xelement, "BindYuanBao"), 0);
