...
public class NcRandomTimerTool : NcTimerTool
{
	...
	public bool UpdateRandomTimer()
	{
		...
		if (flag)
		{
			this.m_fUpdateTime += this.m_fMinIntervalTime + Random.value % this.m_fRandomTime;
			this.m_nCallCount++;
	...
	{
		this.m_fUpdateTime = base.GetTime() + this.m_fMinIntervalTime + Random.value % this.m_fRandomTime;
	}
	...
	public void SetRelTimer(float fStartRelTime, float fRandomTime)
	{
		...
		this.m_fUpdateTime = Random.value % this.m_fRandomTime;
