...
public class MeiRiHuoDongPart : UserControl
{
	public MeiRiHuoDongPart()
	{
	...
	private void InitActivityList()
	{
		...
		for (int i = 0; i < xelementList.Count; i++)
		{
			...
			if (Global.GetXElementAttributeInt(xelement, "Type") == 3)
			{
				GTextBlockEx gtextBlockEx = null;
				GIcon gicon = null;
				...
				if (xelementAttributeInt > 0)
				{
					...
					{
						gtextBlockEx = new GTextBlockEx(string.Empty, -1, -1, -1, -1, 0);
				...
				dailyTasksItem.TimesText = Global.GetXElementAttributeStr(xelement, "Information");
				dailyTasksItem.ObjectPublishName = ((!(null != gtextBlockEx)) ? null : gtextBlockEx);
				...
				dailyTasksItem.BtnChuansong = ((!(null != gicon)) ? null : gicon);
