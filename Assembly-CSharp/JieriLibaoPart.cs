...
public class JieriLibaoPart : UserControl
{
	...
	public void OnLingquCompleted(int result)
	{
		...
		if (result >= 0)
		{
			GGameInfocs.AddGameInfoMessage(GameInfoTypeIndexes.Hot, ShowGameInfoTypes.ErrAndBox, Global.GetLang("恭喜你，成功领取了节日大礼包"), 0, -1, -1, 0);
			this.state = result;
			this.SetBtnState(0, result);
		}
	}
