...
public class UniWebViewPlugin
{
	...
	{
		return Application.platform == 11 && UniWebViewPlugin.webView.CallStatic<bool>("_UniWebViewCanGoBack", new object[]
		{
			name
		});
	}
	...
	{
		return Application.platform == 11 && UniWebViewPlugin.webView.CallStatic<bool>("_UniWebViewCanGoForward", new object[]
		{
			name
		});
	}
