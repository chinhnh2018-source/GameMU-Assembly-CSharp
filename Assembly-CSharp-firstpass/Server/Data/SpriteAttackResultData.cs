...
namespace Server.Data
{
	...
	public class SpriteAttackResultData : IProtoBuffData
	{
		public int fromBytes(byte[] data, int offset, int count)
		{
			...
			while (i < count)
			{
				...
				case 5:
					...
					break;
				case 6:
					this.experience = ProtoUtil.LongMemberFromBytes(data, wt, ref result, ref i);
					break;
				case 7:
		...
		public byte[] toBytes()
		{
			...
			num += ProtoUtil.GetLongSize(this.experience, true, 6, true, 0L);
			...
			ProtoUtil.LongMemberToBytes(array, 6, ref num2, this.experience, true, 0L);
