...
namespace Server.Data
{
	...
	public class SpriteInjuredData : IProtoBuffData
	{
		public int fromBytes(byte[] data, int offset, int count)
		{
			...
			while (i < count)
			{
				...
				case 14:
					...
					break;
				case 15:
					this.subArmor = ProtoUtil.IntMemberFromBytes(data, wt, ref result, ref i);
					break;
				default:
		...
		public byte[] toBytes()
		{
			...
			num += ProtoUtil.GetIntSize(this.subArmor, true, 15, true, 0);
			...
			ProtoUtil.IntMemberToBytes(array, 15, ref num2, this.subArmor, true, 0);
			return array;
		}
