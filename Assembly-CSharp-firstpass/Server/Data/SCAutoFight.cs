...
namespace Server.Data
{
	...
	public class SCAutoFight : IProtoBuffData
	{
		...
		public int fromBytes(byte[] data, int offset, int count)
		{
			...
			while (i < count)
			{
				...
				case 2:
					...
					break;
				case 3:
					this.FightType = ProtoUtil.IntMemberFromBytes(data, wt, ref result, ref i);
					break;
				case 4:
					this.Tag = ProtoUtil.IntMemberFromBytes(data, wt, ref result, ref i);
					break;
				default:
		...
		public byte[] toBytes()
		{
			...
			num += ProtoUtil.GetIntSize(this.FightType, true, 3, true, 0);
			num += ProtoUtil.GetIntSize(this.Tag, true, 4, true, 0);
			...
			ProtoUtil.IntMemberToBytes(array, 3, ref num2, this.FightType, true, 0);
			ProtoUtil.IntMemberToBytes(array, 4, ref num2, this.Tag, true, 0);
			return array;
		}
