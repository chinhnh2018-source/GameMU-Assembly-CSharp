...
public class UIPopupList : MonoBehaviour
{
	...
	private void Highlight(UILabel lbl, bool instant)
	{
		if (this.mHighlight != null)
		{
			...
			float num2 = atlasSprite.inner.yMin - atlasSprite.outer.yMin;
	...
	private void OnClick()
	{
		if (this.mChild == null && this.atlas != null && this.font != null && this.items.Count > 0)
		{
			...
			while (i < count)
			{
				...
				if (this.SelectItemTextHaveColor)
				{
					uilabel.color = ((!(uilabel.text == this.selection)) ? this.NormalItemTextColor : this.SelectItemTextColor);
				}
				else
				{
					uilabel.color = ((!this.hasHighlightLable || this.highLightIndex != i) ? this.textColor : this.highlightLableColor);
				}
			...
			if (this.onLoadItemFinish != null)
			{
				this.onLoadItemFinish();
			}
		}
		else
		{
	...
	public List<UILabel> GetPopupLblChildren()
	{
	...
	public bool hasHighlightLable;

	public int highLightIndex;

	public Color highlightLableColor = Color.yellow;
	...
	public bool SelectItemTextHaveColor;

	public Color SelectItemTextColor = Color.white;

	public Color NormalItemTextColor = Color.white;
	...
	public UIPopupList.OnClickAction onLoadItemFinish;
