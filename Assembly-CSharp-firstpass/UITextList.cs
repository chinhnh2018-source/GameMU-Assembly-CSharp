...
public class UITextList : MonoBehaviour
{
	...
	protected void Add(string text, bool updateVisible)
	{
		...
		{
			paragraph.lines = this.textLabel.font.WrapText(paragraph.text, this.maxWidth / this.textLabel.transform.localScale.y, this.textLabel.maxLineCount, this.textLabel.supportEncoding, this.textLabel.symbolStyle, default(Vector2)).Split(this.mSeparator);
			this.mTotalLines = 0;
			int i = 0;
