...
public class iTween : MonoBehaviour
{
	...
	private void GenerateTargets()
	{
		...
		if (text != null)
		{
			...
			int num;
			if (iTween.<>f__switch$map16.TryGetValue(text, ref num))
			{
				switch (num)
				{
				case 0:
	...
	private void GenerateLookToTargets()
	{
		...
		if (this.tweenArguments.Contains("axis"))
		{
			...
			if (text != null)
			{
				...
				int num;
				if (iTween.<>f__switch$map17.TryGetValue(text, ref num))
				{
					switch (num)
					{
					case 0:
		...
		if (args.Contains("looktarget"))
		{
			...
			if (args.Contains("axis"))
			{
				...
				if (text != null)
				{
					...
					int num2;
					if (iTween.<>f__switch$map18.TryGetValue(text, ref num2))
					{
						switch (num2)
						{
						case 0:
	...
	private void RetrieveArgs()
	{
		...
		if (this.tweenArguments.Contains("namedcolorvalue"))
		{
			...
			else if (Enum.Parse(typeof(iTween.NamedValueColor), (string)this.tweenArguments["namedcolorvalue"], true) != null)
			{
		...
		if (this.tweenArguments.Contains("looptype"))
		{
			...
			else if (Enum.Parse(typeof(iTween.LoopType), (string)this.tweenArguments["looptype"], true) != null)
			{
		...
		if (this.tweenArguments.Contains("easetype"))
		{
			...
			else if (Enum.Parse(typeof(iTween.EaseType), (string)this.tweenArguments["looptype"], true) != null)
			{
		...
		if (this.tweenArguments.Contains("space"))
		{
			...
			else if (Enum.Parse(typeof(Space), (string)this.tweenArguments["looptype"], true) != null)
			{
